 ...
 */
export class MessagingOneOffMessage<TReceive, TReply>
  implements IMessagingOneOffMessage<TReceive, TReply, browser.Runtime.MessageSender>
{
  constructor() {}
   ...
   */
  public onMessage(
    callback: (message: TReceive, sender?: browser.Runtime.MessageSender) => Promise<TReply>,
  ): void {
